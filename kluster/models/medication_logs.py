...
class MedicationLogs(BaseModel):
    ...
    def __init__(self, user_id: int, medication_id: int, time_taken: datetime, taken_status: bool, scheduled_time: datetime, notes: str = None, reminder_sent: bool = False, acknowledged: bool = False):
        super().__init__()
